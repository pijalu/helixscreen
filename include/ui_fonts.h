...
LV_FONT_DECLARE(mdi_icons_96);  // Large hero icons (XLARGE displays)
LV_FONT_DECLARE(mdi_icons_80);  // Large hero icons (XLARGE displays)
LV_FONT_DECLARE(mdi_icons_64); // Navigation bar icons
LV_FONT_DECLARE(mdi_icons_56);  // Large UI icons (XLARGE displays)
LV_FONT_DECLARE(mdi_icons_48); // Status card icons (large displays)
LV_FONT_DECLARE(mdi_icons_40);  // Status card icons (XLARGE displays)
LV_FONT_DECLARE(mdi_icons_32); // Status card icons (small displays)
LV_FONT_DECLARE(mdi_icons_28);  // General UI icons (medium displays)
LV_FONT_DECLARE(mdi_icons_24); // General UI icons (tiny displays)
LV_FONT_DECLARE(mdi_icons_20);  // Small UI icons (compact displays)
