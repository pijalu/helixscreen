...
FONT_SRCS := assets/fonts/mdi_icons_64.c assets/fonts/mdi_icons_48.c assets/fonts/mdi_icons_32.c assets/fonts/mdi_icons_24.c assets/fonts/mdi_icons_16.c assets/fonts/mdi_icons_14.c \
             assets/fonts/mdi_icons_128.c assets/fonts/mdi_icons_96.c \
...
# Noto Sans - Regular weight (8-40px)
FONT_SRCS += assets/fonts/noto_sans_8.c assets/fonts/noto_sans_10.c assets/fonts/noto_sans_11.c assets/fonts/noto_sans_12.c assets/fonts/noto_sans_14.c assets/fonts/noto_sans_16.c assets/fonts/noto_sans_18.c assets/fonts/noto_sans_20.c assets/fonts/noto_sans_24.c assets/fonts/noto_sans_26.c assets/fonts/noto_sans_28.c \
             assets/fonts/noto_sans_32.c assets/fonts/noto_sans_40.c
# Noto Sans - Light weight (8-26px for text_small/text_xs)
...
# Source Code Pro - Monospace (8-24px for console/terminal)
FONT_SRCS += assets/fonts/source_code_pro_8.c assets/fonts/source_code_pro_10.c assets/fonts/source_code_pro_12.c assets/fonts/source_code_pro_14.c assets/fonts/source_code_pro_16.c \
